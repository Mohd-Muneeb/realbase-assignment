import { NotificationTypePayload } from "@prisma/client";
import React, { useRef } from "react";

export const NotificationCard = ({
  Notification,
}: {
  Notification: NotificationTypePayload;
}) => {
      ...
      <div className="flex w-[20rem] items-start justify-between gap-2">
        {
          ...
          <img
            ...
            src={Notification.objects.user.objects.image?.scalars.original_url}
          />
        }
        <div className="w-full">
          ...
          <p className="max-w-full text-sm">{Notification.scalars.body}</p>
